...
### Verdict: [COHERENT / MOSTLY COHERENT / GAPS FOUND]
...
Result: [one sentence]
Arc holds: [YES / NO -- reason]

### Section-by-section results
- Abstract: [PASS / issues found]
- Introduction: [PASS / issues found]
- Related Work: [PASS / issues found]
- Method: [PASS / issues found]
- Evaluation: [PASS / issues found]
- Discussion: [PASS / issues found]

### Transition failures
- [Concept X] appears in [Section] without prior introduction
- [Section A] -> [Section B]: logical gap because [reason]

### Unsupported claims
- "[claim]" in Section [X] -- no evidence provided

### Routing
- Text fixes: [list] -> pass to write
- Missing baselines to verify: [list] -> pass to scout
- Experiments needed to support claims: [list] -> pass to experiments
```
